<template>
  <data-view
    ...
    :title-id="titleId"
    :date="date"
    :source-title="$t('新型コロナウイルスワクチン接種について（特設ページ）')"
    :source-url="
      $t(
...
import agencyData from '@/data/vaccination-total.json'
import DataView from '@/components/DataView.vue'
import { getGraphSeriesStyle } from '@/utils/colorsVaccinationTotal.ts'
